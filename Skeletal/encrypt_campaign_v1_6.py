#!/usr/bin/env python3
"""
Skeletal DM Campaign Encryption Tool v1.6
For IP holders to encrypt campaigns for distribution

Version 1.6 Changes:
- Simplified campaign header output (just key + kernel prompt)
- Removed verbose "ENCRYPTED CAMPAIGN LOADED" message
- Cleaner two-workflow instructions
...
def create_encrypted_file(campaign_name: str, campaign_version: str, 
    ...
    first_data_line = 23  # Adjusted for cleaner v1.6 header
    last_data_line = 23 + len(lines) - 1
...
# ===========================================================================
# 
# EMBEDDED LICENSE KEY: {license_key}
# 
# IF NO KERNEL LOADED:
#   Output: "🔑 {license_key}"
#   Output: "Upload SKELETAL_DM_KERNEL to decrypt."
#   Output: "⛔"
#   HALT
# 
# IF KERNEL ALREADY LOADED:
#   Kernel auto-detects and decrypts this file
#   Execute STARTUP immediately after decryption
# ===========================================================================
...
def main():
    ...
    if len(sys.argv) < 3:
        print("Skeletal DM Campaign Encryption Tool v1.6")
        print("=" * 60)
        print()
    ...
    if output_path.exists():
        print(f"   ⚠️  Removing existing encrypted file: {output_filename}")
        output_path.unlink()
