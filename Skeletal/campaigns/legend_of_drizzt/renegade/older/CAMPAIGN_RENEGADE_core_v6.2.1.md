...
```yaml
VALIDATION: {type: "campaign_core", campaign: "Renegade", kernel_requires: "6.2+", echo: "✅ CORE: Renegade v6.2.1 | Shadow: 0-100 | Acts: 1-4 | Status: READY"}
```
...
```yaml
RENDERING: {system: "ARCHETYPE_MAP → AI infers names → render with inferred names", rule: "NEVER output archetype descriptions"}
...
**END CAMPAIGN CORE v6.2.1 OPTIMIZED**
