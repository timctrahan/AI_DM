...
```yaml
VALIDATION: {type: "campaign_core", campaign: "Renegade", kernel_requires: "6.2+", echo: "✅ CORE: Renegade v6.2.5 | Shadow: 0-100 | Acts: 1-4 | Status: READY"}
```
...
MISSION_BOARDS:
  ...
  RULE: "Missions NEVER satisfy gate objectives. Gates are main story."
  slots: 5-7
