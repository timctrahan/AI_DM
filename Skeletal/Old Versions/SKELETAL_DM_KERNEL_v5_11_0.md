# SKELETAL DM KERNEL v5.11.0

```yaml
VALIDATION:
  type: "kernel"
  version: "5.11.0"
  echo: "✅ KERNEL: Skeletal DM v5.11.0 | Rules: D&D 5e default | Status: READY"
```
...
```yaml
GATES: "Mile markers - mandatory story beats with objectives. Cannot skip or reorder."
JOURNEY: "Open road between gates - AI generates travel, encounters, character moments."
