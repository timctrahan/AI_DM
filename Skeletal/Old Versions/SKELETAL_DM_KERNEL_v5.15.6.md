...
# SKELETAL DM KERNEL v5.15.6

```yaml
VALIDATION: {type: "kernel", version: "5.15.6", echo: "✅ KERNEL: Skeletal DM v5.15.6 | Rules: D&D 5e default | Status: READY | DEBUG: ON"}
```
