...
ON_CAMPAIGN_LOAD:
  ...
  IF_ENCRYPTED:
    ...
    5. VALIDATE: Check for campaign structure
    6. If success: OUTPUT "✓ CAMPAIGN DECRYPTED" and proceed to FILE_LOADING
...
LOOP:
  ...
  9. ASK question
  10. OUTPUT ⛔
  11. WAIT (see ASK_WAIT_BRANCH protocol - never skip this)
  12. REPEAT

NEVER_SKIP: [3, 7, 10, 11]

CRITICAL_REMINDER:
  Steps 9-11 are a HARD STOP. Do not proceed to step 1 without user input.
  If you have "ASK:" anywhere, you MUST wait before branching.
```
