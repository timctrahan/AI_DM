...
def create_encrypted_file(campaign_name: str, campaign_version: str, 
    ...
    file_content = f'''# SKELETAL_DM_ENCRYPTED_CAMPAIGN_V3
...
# POST_LOAD: run_startup_immediately=true|no_menu_layer=true|first_wait_source=startup_ask
# KERNEL_FLOW: on_campaign_load->decrypt->file_loading->silent_verify->execute_startup
# KEY_INPUT: allow_inline_key=true|prompt_if_missing=true
# MATERIALIZATION: recommended_sequence=campaign_first_then_kernel
