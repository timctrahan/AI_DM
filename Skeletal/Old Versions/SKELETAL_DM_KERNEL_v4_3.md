# SKELETAL DM UNIVERSAL KERNEL v4.3
...
```yaml
COMMANDS:
  /map: Party, enemies, exits, hazards (code block)
  /status: Name/level, HP, slots, gold, conditions (code block)
  /progress: Act, objectives, gates completed (code block)
