#!/usr/bin/env python3
"""
Skeletal DM Campaign Encryption Tool v1.1
For IP holders to encrypt campaigns for distribution

Version 1.1 Changes:
- Updated encrypted file headers to include bash cat loading instructions
- Prevents AI truncation issues with large campaign files (500+ lines)
- Ensures complete campaign loads into AI context
