# SKELETAL DM KERNEL v5.9.2

```yaml
VALIDATION:
  type: "kernel"
  version: "5.9.2"
  echo: "✅ KERNEL: Skeletal DM v5.9.2 | Rules: D&D 5e default | Status: READY"
```
...
LOOP:
  ...
  STEP_3_PRESENT:
    check_first: [Combat nearby, Hostile presence, Tactical choice required]
    if_any: "TACTICAL_NARRATION → map → then present"
