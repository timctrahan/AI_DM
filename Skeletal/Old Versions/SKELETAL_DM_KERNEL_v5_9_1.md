# SKELETAL DM KERNEL v5.9.1

```yaml
VALIDATION:
  type: "kernel"
  version: "5.9.1"
  echo: "✅ KERNEL: Skeletal DM v5.9.1 | Rules: D&D 5e default | Status: READY"
```
...
LOOP:
  ...
  STEP_3_PRESENT:
    default: "Describe current scene/state"
    if_imminent: "TACTICAL_NARRATION → map → then present"
