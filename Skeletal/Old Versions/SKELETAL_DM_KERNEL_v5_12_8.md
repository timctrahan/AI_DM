# SKELETAL DM KERNEL v5.12.8

```yaml
VALIDATION:
  type: "kernel"
  version: "5.12.8"
  echo: "✅ KERNEL: Skeletal DM v5.12.8 | Rules: D&D 5e default | Status: READY"
```
...
STEP_A_ASSIGN: "Give EVERY entity a cardinal position (north/south/east/west/center)"
