...
**Deep Gnome Prisoners** (3-5 NPCs, deep gnome)
...
- Inhabitants: Hook Beasts nest on walls, Carcass Scavengers scavenge
...
**Encounter: Hook Beast Ambush**
- **Enemies:** 2x Hook Beast (CR 3, 700 XP each)
...
- Hook Beasts pursue 2 rounds then return to nest

**Trait Gained: Vertigo Acclimated**
The party has learned to function on precarious heights. Years of adventuring won't erase this muscle memory.
- **Effect:** Advantage on saves vs falling and fear effects related to heights
- **Duration:** Persists through campaign

#### Carved Path Encounter

**Encounter: Carcass Scavenger Pack (Avoidable)**
- **Setup:** DC 14 Perception to spot crawlers feeding on corpse
- **If spotted:** Can sneak past (group DC 12 Stealth)
- **If engaged:** 3x Carcass Scavenger (CR 2, 450 XP each)
- **Adjusted XP:** 1350 × 2 = 2,700 XP (Deadly)
- **Alternative:** Throw rations as distraction (auto-success)

**Trait Gained: Stone Climber**
Hours of testing handholds have trained the party's climbing instincts.
- **Effect:** +1d4 bonus to Athletics checks involving climbing, handholds, or vertical surfaces
- **Duration:** Persists through campaign
...
**Trait Gained: Spore Resistant**
Prolonged exposure to fungal spores has built up the party's resistance to toxins.
- **Effect:** Advantage on saves vs poison and disease
- **Duration:** Persists through campaign
...
- Alert monsters: Hook Beasts investigate noise
...
2. **Hook Beast Cry:** Echoes through chasm (unnerving, no effect)
...
>
> *Gralk (if present): "By The Gray Protector's beard... this place is enormous. We'll need weeks to reach that spire."*
>
...
- 1x Drow Priestess of The Spider Queen (CR 8, 3,900 XP)
...
**Discovery:**
- Caravan attacked by Hook Beasts
- 2 survivors (duergar warriors, wounded)
- Cargo intact but scattered

**Encounter: Hook Beast Cleanup**
- **Enemies:** 1x Hook Beast (CR 3, 700 XP)
...
**Investigation:**
- DC 13 Nature: Recognize hostile fungi (The Rot Goddess's corruption)
...
- **Enemy:** 1x Fungal Thrall (CR 2, 450 XP)
...
**Summary:** Small group of deep gnomes (deep gnome) escaped duergar slavers. They're trying to reach surface but are lost, wounded, and pursued.
...
velryn_duskmere:
  ...
  quest_hooks:
    ...
    - "House Shadowveil Confrontation" (Act 2): Face her former mentor
...
sunless_chasm:
  ...
  description: |
    ...
    and bioluminescent fungi grow on ledges. Hook Beasts nest 
    in crevices.
  
  three_routes:
    bridges:
      time: "4 hours"
      danger: "High (collapsing bridges, Hook Beasts)"
      dc: 13
      
    carved_path:
      time: "8 hours"
      danger: "Medium (climbing, Carcass Scavengers)"
      dc: 12
  ...
  hazards:
    ...
    - Hook Beast attacks: See encounter details
  
  atmosphere:
    - Vertigo-inducing depths
    - Echoing cries of Hook Beasts
...
difficulty_breakdown:
  ...
  medium: 6 encounters
  hard: 2 encounters
  deadly: 1 encounter (avoidable: chasm Hook Beasts)
...
route_taken: [bridges/carved/fungal]
descent_trait: [vertigo_acclimated/stone_climber/spore_resistant]
reputation:
  surface: [score]
  duergar: [score]
  gnomes: [score]
